...
function JobCardAlt2(props) {
    return (
        <div className="w-80 h-min border-none shadow-lg mx-3">
            ...
            <div className="flex flex-row justify-between px-3 py-2">
                <div className="flex flex-col">
                    <p className="text-base">Cancellation reason</p>
                    <p className="text-gray text-sm">Unavailable at the scheduled time</p>
                </div>
            </div>
        </div>
    )
